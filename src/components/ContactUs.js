      ...
      <section className="text-gray-600 body-font relative">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col text-center w-full mb-12">
            <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900 font-semibold">Contact Us</h1>
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
              Have a question or want to know more about our courses? We'd love to hear from you! Reach out to us using the form below, and we'll get back to you as soon as possible.
            </p>
          </div>
          <div className="lg:w-1/2 md:w-2/3 mx-auto">
            <div className="flex flex-wrap -m-2">
              ...
              <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                <a className="text-pink-500">info@education.com</a>
                <p className="leading-normal my-5">1234 Learn St.
                  <br/>Cityville, NY 56789
                </p>
